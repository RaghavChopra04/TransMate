...
class StartTranslationPage:
    def __init__(self, root):
        ...
        self.language_label = ttk.Label(self.root, text="Select Language:",font=("Arial", 16), foreground="sky blue", background="black")
...
class HomePage:
    def __init__(self, root):
        ...
        about_frame.configure(background="black") 
        ...
        start_frame.configure(background="black")   
